...
+ The Baltimore Poe Society's bibliography of editions, impressions and reprintings of the raven: https://www.eapoe.org/works/info/pp073.htm
+ Additional searches in Chronicling America for matching lines.

This Poe dataset can be found here: .

Please navigate to the dataset. Right click and save the CSV file. Open up the file using VSCode or a simple text editor. Copy it
...
Either paste the link to the URl or upload.
